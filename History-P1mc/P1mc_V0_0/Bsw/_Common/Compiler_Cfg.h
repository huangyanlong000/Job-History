 ...
 *
 * V1.0.1:  21-Sep-2016  : 1.As part of ARDAAAF-479, to adapt internal functions
 *                         CORTST_PRIVATE_CODE is defined.
 *                         2.As part of ARDAAAF-543, to adapt internal functions
 *                         FLSTST_PRIVATE_CODE is defined and Copyright Updated.
 * V1.0.2:  02-May-2017  : Following changes are made:
 *                         1. As part of ARDAAAF-2355, repeated macro definition
 *                            for MCU_FAST_DATA is removed.
 * V1.0.3:  18-Jul-2019  : As part of ARDAAAF-3635, the following changes are
 *                         made:
 *                         a) Macros defined multiple times are removed.
...
#define FLSTST_INIT_DATA                /* Data which is initialized during   */
                                        /*Startup                             */
#define FLSTST_NOINIT_DATA              /* Data which is not initialized      */
                                        /* during Startup                     */
