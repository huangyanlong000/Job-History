 ...
 * V1.0.1:  15-Feb-2016  : As part of P1x-C 4.01.00 release the following
 *                         changes were made:
 *                         1. Copyright information is updated.
 *                         2. Macro definition for supervisor mode(SV) write
 *                            enabled Registers IMR & ICxxx added.
 * V1.0.2:  01-Sep-2019  : 1. As part of ARDAAAF-3334, the following changes are
 *                            made:
 *                         a) Added macros RH850_SET_IOREG_SYNCP,
 *                            RH850_CLEAR_IOREG_SYNCP, RH850_SV_WRITE_ICR_SYNCP,
 *                            RH850_WRITE_ONLY_IOREG_SYNCP,
 *                            RH850_SV_CLEAR_ICR_SYNCP, RH850_SV_SET_ICR_SYNCP.
 *                         b) Copyright information is updated.
 *                         2. As part of ARDAAAF-3685, the following changes are
 *                            made:
 *                         a) Range mentioned in the comment for definition
 *                            of type 'uinteger' is updated.
 *                         b) Added a comment with the declaration of type
 *                            'uinteger'.
 *                         c) Removed macros RH850_SV_MODE_IMR_OR,
 *                            RH850_SV_MODE_IMR_WRITE_ONLY,
 *                            RH850_SV_MODE_IMR_AND.
 *                         3. As part of ARDAAAF-4222, added
 *                            RH850_IOREG_READ_ONLY,
 *                            RH850_SV_MODE_REG_READ_ONLY.
 * V1.0.3:  18-May-2021  : As part of ARDAAAF-4636, the following changes are
 *                         made:
 *                         a) Removed the macro 'RH850_SV_MODE_ICR_WRITE_ONLY'.
 *                         b) Updated the copyright information.
 * V1.0.4:  21-May-2021  : As part of ARDAAAF-4635, added the macro
 *                         'RH850_DUMMY_READ_SYNCP'.
 */
/******************************************************************************/
...
**                         Dummy read of register is executed after write.
**
** Input Parameters      : SIZE, ADDR, VAL
**                         SIZE : Register Access Size.
**                         ADDR : Register address
...
/*******************************************************************************
** Macro Name            : RH850_WRITE_ONLY_IOREG_SYNCP
**
** Description           : This Macro performs direct writing of IOREG with
**                         SYNCP. Dummy read of register is executed after
**                         write.
**
** Input Parameters      : SIZE, ADDR, VAL
**                         SIZE : Register Access Size.
...
**                         VAL  : Value to be written to the register.
*******************************************************************************/
#define RH850_WRITE_ONLY_IOREG_SYNCP(SIZE, ADDR, VAL)                          \
                            (*((volatile uint##SIZE*)(ADDR)) = (VAL));         \
                            (*((volatile uint##SIZE*)(ADDR)));                 \
                            EXECUTE_SYNCP();
...
**
** Description           : This Macro performs supervisor mode dummy reading of
**                         a register.
**
** Input Parameters      : SIZE, ADDR
**                         SIZE : Register Access Size.
...
**
** Description           : This Macro performs a dummy reading of register with
**                         SYNCP.
**
** Input Parameters      : SIZE, ADDR
**                         SIZE : Register Access Size.
