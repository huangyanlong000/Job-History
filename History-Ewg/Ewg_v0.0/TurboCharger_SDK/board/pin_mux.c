...
- pin_list:
  ...
  - {pin_num: '19', peripheral: FTM0, signal: 'ch, 1', pin_signal: PTC1, direction: OUTPUT}
  - {pin_num: '45', peripheral: PORTC, signal: 'port, 5', pin_signal: PTC5, direction: OUTPUT}
  - {pin_num: '20', peripheral: PORTC, signal: 'port, 16', pin_signal: PTC16, direction: OUTPUT}
  - {pin_num: '21', peripheral: PORTC, signal: 'port, 15', pin_signal: PTC15, direction: OUTPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
