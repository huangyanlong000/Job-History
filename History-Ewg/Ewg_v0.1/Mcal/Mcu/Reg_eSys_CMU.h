...
#define REG_ESYS_CMU_SW_PATCH_VERSION                5
...
/* Check if header file and Mcu_CMU_IPVersion header file are from the same vendor */
#if (REG_ESYS_CMU_VENDOR_ID != MCU_CMU_IPVERSION_VENDOR_ID)
    #error "Reg_eSys_CMU.h and Mcu_CMU_IPVersion.h have different vendor ids"
#endif
/* Check if header file and Mcu_CMU_IPVersion header file are of the same Autosar version */
     ...
     (REG_ESYS_CMU_AR_RELEASE_REVISION_VERSION != MCU_CMU_IPVERSION_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((REG_ESYS_CMU_SW_MAJOR_VERSION != MCU_CMU_IPVERSION_SW_MAJOR_VERSION) || \
     (REG_ESYS_CMU_SW_MINOR_VERSION != MCU_CMU_IPVERSION_SW_MINOR_VERSION) || \
     (REG_ESYS_CMU_SW_PATCH_VERSION != MCU_CMU_IPVERSION_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Reg_eSys_CMU.h and Mcu_CMU_IPVersion.h are different"
#endif
