...
#define MCU_HSRUN_MODE_NOT_SUPPORT (STD_ON)
...
*/
#define MCU_PLATGC_GPIO_CLK_SUPPORT (STD_ON)
...
*/
#define MCU_CMU_UNITS   ((uint8)2U)


/**
* @brief            define for interrupt CMU, PMC, SCG peripheral
*/
#define MCU_CMU_PMC_SCG_INTERRUPT  (STD_ON)
...
#define MCU_NUMBER_OF_PCC_REGISTERS_U32         ((uint32)24U)
