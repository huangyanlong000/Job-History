...
#define MCU_CMU_SW_PATCH_VERSION_C               5
...
#ifdef MCU_CMU_RCDIV
/**
* @brief            This function initializes CMU_CSR Register for per CMU unit.
* @details          CMU_CSR Register are used for monitoring major frequencis on the platform.
*                       - Mcu_Ipw_WaitForStableXosc() from IPW.
*
* @param[in]        u8CmuUnit        The CMU UNIT number
*                   u32CmuCsrRcdiv   CSR_RCDIV value
*
* @return           void
*
*/
...
{
    /* Index for CMU units. */
    VAR(uint8, AUTOMATIC)   u8IndexCmu;
    
    for(u8IndexCmu = 0U; u8IndexCmu < MCU_CMU_RCDIV; u8IndexCmu++)
    {
        /** @violates @ref Mcu_CMU_c_REF_3 Cast from unsigned long to pointer.*/
        /** @violates @ref Mcu_CMU_c_REF_6 The cast is used to access memory mapped registers.*/
        REG_RMW32(CMU_CSR_X_ADDR32(pCmu_ConfigPtr-> au8CmuRcdivExisted[u8IndexCmu]), CMU_CSR_RCDIV_MASK32, pCmu_ConfigPtr-> au32CmuRcdivValue[u8IndexCmu]);
    }
...
FUNC(void, MCU_CODE) Mcu_CMU_Init(P2CONST(Mcu_CMU_ConfigType, AUTOMATIC, MCU_APPL_CONST) pCmu_ConfigPtr)
{
...
#ifdef MCU_ERR11287_001
    /* FLCI status */
    VAR(uint32, AUTOMATIC)  u32cmuFLCIValue = 0U;
#endif
#endif
#endif
    ...
    for(u8IndexCmu = 0U; u8IndexCmu < MCU_CMU_UNITS; u8IndexCmu++)
    {
        ...
        /* For RRU1 and Calypso, RCDIV will be writen before turn on CLKMN0_RMT clock */
        /** @violates @ref Mcu_CMU_c_REF_3 Cast from unsigned long to pointer.*/
        /** @violates @ref Mcu_CMU_c_REF_6 The cast is used to access memory mapped registers.*/
        REG_RMW32(CMU_CSR_X_ADDR32(u8IndexCmu), CMU_CSR_CME_MASK32, pCmu_ConfigPtr-> au32CmuConfig[u8IndexCmu]);
#else
        /* Set CMU control register. */
        /** @violates @ref Mcu_CMU_c_REF_3 Cast from unsigned long to pointer.*/
        /** @violates @ref Mcu_CMU_c_REF_6 The cast is used to access memory mapped registers.*/
...
#if (STD_ON == MCU_CMU_FLCI_BIT_PRESENT)
#ifdef MCU_ERR11287_001
        u32cmuFLCIValue = REG_READ32(CMU_ISR_X_ADDR32(u8IndexCmu)) & CMU_ISR_FLCI_MASK32;
        if(u32cmuFLCIValue == CMU_ISR_FLCI_MASK32)
        {
            /* Clear FLCI flag */
            /** @violates @ref Mcu_CMU_c_REF_3 Cast from unsigned long to pointer.*/
            /** @violates @ref Mcu_CMU_c_REF_6 The cast is used to access memory mapped registers.*/
            REG_WRITE32(CMU_ISR_X_ADDR32(u8IndexCmu), u32cmuFLCIValue);
        }
#endif
#endif
#endif
...
)
{
    ...
    if(NULL_PTR != Mcu_pConfigPtr)
    {
        ...
        if(CMU_CSR_CME_MASK32 == (CMU_CSR_CME_MASK32 & u32cmuCsrValue))
        {
            ...
            if((((uint8)0x00U == u8CmuIdx) || ((uint8)0x07U == u8CmuIdx)) && (CMU_ISR_OLRI_MASK32 == (CMU_ISR_OLRI_MASK32 & u32cmuIsrValue)))
            {
                CmuStatus = (Std_ReturnType)E_NOT_OK;
            }
#ifdef MCU_CMU_FLCI_BIT_PRESENT
            ...
            if(CMU_ISR_FLCI_MASK32 == (CMU_ISR_FLCI_MASK32 & u32cmuIsrValue))
            {
                CmuStatus = (Std_ReturnType)E_NOT_OK;
            }
#endif
