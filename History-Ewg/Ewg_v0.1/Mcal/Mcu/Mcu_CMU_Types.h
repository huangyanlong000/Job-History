...
#define MCU_CMU_TYPES_SW_PATCH_VERSION             5


/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
/* Check if header file and Mcu_Cfg header file are from the same vendor */
...
/* Check if header file and Reg_eSys_CMU header file are from the same vendor */
#if (MCU_CMU_TYPES_VENDOR_ID != REG_ESYS_CMU_VENDOR_ID)
    #error "Mcu_CMU_Types.h and Reg_eSys_CMU.h have different vendor ids"
#endif
/* Check if header file and Reg_eSys_CMU header file are of the same Autosar version */
...
#endif
/* Check if header file and Reg_eSys_CMU header file are of the same Software version */
...
#if (MCU_CMU_TYPES_VENDOR_ID != MCU_CMU_IPVERSION_VENDOR_ID)
    #error "Mcu_CMU_Types.h and Mcu_CMU_IPVersion.h have different vendor ids"
#endif
/* Check if header file and Mcu_CMU_Types header file are of the same Autosar version */
     ...
     (MCU_CMU_TYPES_AR_RELEASE_REVISION_VERSION != MCU_CMU_IPVERSION_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_CMU_Types.h and Mcu_CMU_IPVersion.h are different"
#endif
/* Check if header file and Mcu_CMU_Types header file are of the same Software version */
#if ((MCU_CMU_TYPES_SW_MAJOR_VERSION != MCU_CMU_IPVERSION_SW_MAJOR_VERSION) || \
     (MCU_CMU_TYPES_SW_MINOR_VERSION != MCU_CMU_IPVERSION_SW_MINOR_VERSION) || \
     (MCU_CMU_TYPES_SW_PATCH_VERSION != MCU_CMU_IPVERSION_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_CMU_Types.h and Mcu_CMU_IPVersion.h are different"
#endif
...
#define CMU_CSR_RCDIV_RESET_U32          ((uint32)0x00000006U)
...
#ifdef MCU_CMU_RCDIV
    /**< @brief CMU RCDIV bit field can be writen. */
    VAR (uint8, MCU_VAR) au8CmuRcdivExisted[MCU_CMU_RCDIV];
    /**< @brief CLKMN0_RMT clock if Mcu under control or not */
    VAR (uint32, MCU_VAR) au32CmuRcdivValue[MCU_CMU_RCDIV];
#endif
