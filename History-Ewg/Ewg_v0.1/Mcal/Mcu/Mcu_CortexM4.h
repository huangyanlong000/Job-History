...
#define MCU_CORTEXM4_SW_PATCH_VERSION                5
...
#if (MCU_CORTEXM4_VENDOR_ID != REG_ESYS_CORTEXM4_VENDOR_ID)
#error "Mcu_CortexM4.h and Reg_eSys_CortexM4.h have different vendor IDs"
#endif
...
/* Check if source file and Mcu_CortexM4_Types.h header file have same versions */
#if (MCU_CORTEXM4_VENDOR_ID != MCU_CORTEXM4_TYPES_VENDOR_ID)
#error "Mcu_CortexM4.h and Mcu_CortexM4_Types.h have different vendor IDs"
#endif
#if ((MCU_CORTEXM4_AR_RELEASE_MAJOR_VERSION != MCU_CORTEXM4_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_CORTEXM4_AR_RELEASE_MINOR_VERSION != MCU_CORTEXM4_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (MCU_CORTEXM4_AR_RELEASE_REVISION_VERSION != MCU_CORTEXM4_TYPES_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Mcu_CortexM4.h and Mcu_CortexM4_Types.h are different"
#endif
#if ((MCU_CORTEXM4_SW_MAJOR_VERSION != MCU_CORTEXM4_TYPES_SW_MAJOR_VERSION) || \
     (MCU_CORTEXM4_SW_MINOR_VERSION != MCU_CORTEXM4_TYPES_SW_MINOR_VERSION) || \
     (MCU_CORTEXM4_SW_PATCH_VERSION != MCU_CORTEXM4_TYPES_SW_PATCH_VERSION))
#error "Software Version Numbers of Mcu_CortexM4.h and Mcu_CortexM4_Types.h are different"
#endif
...
/** @violates @ref Mcu_CortexM4_h_REF_3 Function-like macro defined.*/
#define  Call_Mcu_CM4_EnableSleepOnExit() \
do\
{ \
        Mcal_Trusted_Call(Mcu_CM4_EnableSleepOnExit); \
}\
while(0)
    
/** @violates @ref Mcu_CortexM4_h_REF_3 Function-like macro defined.*/
#define  Call_Mcu_CM4_DisableSleepOnExit() \
do\
{ \
        Mcal_Trusted_Call(Mcu_CM4_DisableSleepOnExit); \
}\
while(0)
#endif
