...
#define MCU_IPW_IRQ_SW_PATCH_VERSION              5
...
#if (MCU_IPW_IRQ_VENDOR_ID != MCU_PMC_VENDOR_ID)
...
#if ((MCU_IPW_IRQ_SW_MAJOR_VERSION != MCU_PMC_SW_MAJOR_VERSION) || \
     (MCU_IPW_IRQ_SW_MINOR_VERSION != MCU_PMC_SW_MINOR_VERSION) || \
     (MCU_IPW_IRQ_SW_PATCH_VERSION != MCU_PMC_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_IPW_Irq.c and Mcu_PMC.h are different"
#endif

/* Check if current file and Mcu_SCG header file are of the same vendor */
#if (MCU_IPW_IRQ_VENDOR_ID != MCU_SCG_VENDOR_ID)
...
#if ((MCU_IPW_IRQ_AR_RELEASE_MAJOR_VERSION    != MCU_SCG_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_IPW_IRQ_AR_RELEASE_MINOR_VERSION    != MCU_SCG_AR_RELEASE_MINOR_VERSION) || \
     (MCU_IPW_IRQ_AR_RELEASE_REVISION_VERSION != MCU_SCG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((MCU_IPW_IRQ_SW_MAJOR_VERSION != MCU_SCG_SW_MAJOR_VERSION) || \
     (MCU_IPW_IRQ_SW_MINOR_VERSION != MCU_SCG_SW_MINOR_VERSION) || \
     (MCU_IPW_IRQ_SW_PATCH_VERSION != MCU_SCG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_IPW_Irq.c and Mcu_SCG.h are different"
#endif

/* Check if current file and Mcu_CMU header file are of the same vendor */
#if (MCU_IPW_IRQ_VENDOR_ID != MCU_CMU_VENDOR_ID)
...
#if ((MCU_IPW_IRQ_AR_RELEASE_MAJOR_VERSION    != MCU_CMU_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_IPW_IRQ_AR_RELEASE_MINOR_VERSION    != MCU_CMU_AR_RELEASE_MINOR_VERSION) || \
     (MCU_IPW_IRQ_AR_RELEASE_REVISION_VERSION != MCU_CMU_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((MCU_IPW_IRQ_SW_MAJOR_VERSION != MCU_CMU_SW_MAJOR_VERSION) || \
     (MCU_IPW_IRQ_SW_MINOR_VERSION != MCU_CMU_SW_MINOR_VERSION) || \
     (MCU_IPW_IRQ_SW_PATCH_VERSION != MCU_CMU_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_IPW_Irq.c and Mcu_CMU.h are different"
#endif
