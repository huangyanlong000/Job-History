...
#define MCU_PMC_SW_PATCH_VERSION_C               5
...
FUNC( void, MCU_CODE) Mcu_PMC_PowerInit(P2CONST( Mcu_PMC_ConfigType, AUTOMATIC, MCU_APPL_CONST) pConfigPtr)
{
...
#ifdef MCU_PMC_LVRFLG_SUPPORT
#if (MCU_PMC_LVRFLG_SUPPORT == STD_ON)
    VAR(uint8, AUTOMATIC) u8LVRFLG;
#endif
#endif
#endif
    ...
    /* Check if LVDSC1 register is supported */
#ifdef MCU_PMC_LVDSC1_SUPPORT
#if (MCU_PMC_LVDSC1_SUPPORT == STD_OFF)
    /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
    u32Tmp = ((uint32)pConfigPtr->u8Lvdsc2 << 8) | ((uint32)pConfigPtr->u8Regsc << 16);
#else
    /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
    u32Tmp = ((uint32)pConfigPtr->u8Lvdsc1) | ((uint32)pConfigPtr->u8Lvdsc2 << 8) | ((uint32)pConfigPtr->u8Regsc << 16);
#endif /*(MCU_PMC_LVDSC1_SUPPORT == STD_OFF)*/
#endif /* MCU_PMC_LVDSC1_SUPPORT */
    /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
    REG_RMW32(PMC_BASEADDR, PMC_REG_RWBITS_MASK32, u32Tmp);
    
    /* Clear Low Voltage Reset Flags Register (LVRFLG) */
#ifdef MCU_PMC_LVRFLG_SUPPORT
#if (MCU_PMC_LVRFLG_SUPPORT == STD_ON)
    /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
    u8LVRFLG = REG_READ8(PMC_LVRFLG_ADDR8) & PMC_REG_LVRFLG_MASK8;
    /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
    REG_RMW8(PMC_LVRFLG_ADDR8, PMC_REG_LVRFLG_MASK8, u8LVRFLG);    
#endif /*(MCU_PMC_LVRFLG_SUPPORT == STD_ON)*/
#endif /* MCU_PMC_LVRFLG_SUPPORT */
...
FUNC( void, MCU_CODE) Mcu_PMC_VoltageErrorIsr( VAR( void, AUTOMATIC) )
{
    ...
    /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
    u32VoltageIsrStatus = REG_READ32(PMC_BASEADDR) & PMC_LVDSC1_2_LVDF_LVWF_MASK32;
    /* clear IRQ flags */
    /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
    REG_RMW32(PMC_BASEADDR, PMC_LVDSC1_2_LVDACK_LVWACK_MASK32, (PMC_LVDSC1_2_LVDACK_LVWACK_MASK32 & u32VoltageIsrStatus));
#endif
    ...
    if(NULL_PTR != Mcu_pConfigPtr)
    {
        ...
        /** @violates @ref Mcu_PMC_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
        /** @violates @ref Mcu_PMC_c_REF_6 The cast is used to access memory mapped registers.*/
        u32VoltageIsrEnabled = REG_READ32(PMC_BASEADDR) & ((uint32)PMC_LVDSC1_2_LVDIE_LVWIE_MASK32);
#endif

        /* check if there is an event to report */
#if (IPV_PMC == IPV_PMC_03_00_01_00)
        if((((uint32)0x00000000U != (u32VoltageIsrStatus & PMC_LVDSC1_LVDF_MASK32)) && ((uint32)0x00000000U != (u32VoltageIsrEnabled & PMC_LVDSC1_LVDIE_MASK32))) || 
           (((uint32)0x00000000U != (u32VoltageIsrStatus & PMC_LVDSC2_LVWF_MASK32)) && ((uint32)0x00000000U != (u32VoltageIsrEnabled & PMC_LVDSC2_LVWIE_MASK32))))
#else
