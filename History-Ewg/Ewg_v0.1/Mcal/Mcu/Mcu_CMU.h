...
#define MCU_CMU_SW_PATCH_VERSION             5

/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
/* Check if header file and Mcu_CMU_Types header file are from the same vendor */
#if (MCU_CMU_VENDOR_ID != MCU_CMU_TYPES_VENDOR_ID)
    #error "Mcu_CMU.h and Mcu_CMU_Types.h have different vendor ids"
#endif
/* Check if header file and Mcu_CMU_Types header file are of the same Autosar version */
...
#endif
/* Check if header file and Mcu_CMU_Types header file are of the same Software version */
...
/* Check if header file and Mcu_EnvCfg header file are from the same vendor */
#if (MCU_CMU_VENDOR_ID != MCU_SCFG_VENDOR_ID)
    #error "Mcu_CMU.h and Mcu_EnvCfg.h have different vendor ids"
#endif
/* Check if header file and Mcu_EnvCfg header file are of the same Autosar version */
...
#endif
/* Check if header file and Mcu_EnvCfg header file are of the same Software version */
...
/* Check if header file and Mcu_CMU_IPVersion.h header file are from the same vendor */
#if (MCU_CMU_VENDOR_ID != MCU_CMU_IPVERSION_VENDOR_ID)
    #error "Mcu_CMU.h and Mcu_CMU_IPVersion.h have different vendor ids"
#endif
/* Check if header file and Mcu_CMU_IPVersion header file are of the same Autosar version */
#if ((MCU_CMU_AR_RELEASE_MAJOR_VERSION != MCU_CMU_IPVERSION_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_CMU_AR_RELEASE_MINOR_VERSION != MCU_CMU_IPVERSION_AR_RELEASE_MINOR_VERSION) || \
     (MCU_CMU_AR_RELEASE_REVISION_VERSION != MCU_CMU_IPVERSION_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_CMU.h and Mcu_CMU_IPVersion.h are different"
#endif
/* Check if header file and Mcu_CMU_IPVersion header file are of the same Software version */
#if ((MCU_CMU_SW_MAJOR_VERSION != MCU_CMU_IPVERSION_SW_MAJOR_VERSION) || \
     (MCU_CMU_SW_MINOR_VERSION != MCU_CMU_IPVERSION_SW_MINOR_VERSION) || \
     (MCU_CMU_SW_PATCH_VERSION != MCU_CMU_IPVERSION_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_CMU.h and Mcu_CMU_IPVersion.h are different"
#endif
...
#endif
#endif
#endif /*(IPV_CMU == IPV_CMU_00_00_00_01)*/
...
#if (MCU_INIT_CLOCK == STD_ON)
FUNC( void, MCU_CODE) Mcu_CMU_CSR_RCDIV_CMUx(P2CONST(Mcu_CMU_ConfigType, AUTOMATIC, MCU_APPL_CONST) pCmu_ConfigPtr);
FUNC( void, MCU_CODE) Mcu_CMU_DeInit(VAR( void, AUTOMATIC));
FUNC( void, MCU_CODE) Mcu_CMU_Init(P2CONST(Mcu_CMU_ConfigType, AUTOMATIC, MCU_APPL_CONST) pCmu_ConfigPtr);
FUNC( uint32, MCU_CODE) Mcu_CMU_GetInterruptStatus(VAR(uint8, AUTOMATIC) u8IndexCmu);
FUNC( void, MCU_CODE) Mcu_CMU_ClearInterruptStatus(VAR(uint8, AUTOMATIC) u8IndexCmu, VAR(uint32, AUTOMATIC) u32ClearMask);
