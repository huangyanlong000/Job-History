...
#define FEE_MEMMAP_AR_RELEASE_MINOR_VERSION     2
#define FEE_MEMMAP_AR_RELEASE_REVISION_VERSION  2
#define FEE_MEMMAP_SW_MAJOR_VERSION             1
#define FEE_MEMMAP_SW_MINOR_VERSION             0
#define FEE_MEMMAP_SW_PATCH_VERSION             5
/**@}*/
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
/**************************************** FEE *******************************/
    ...
    */
    #undef FEE_START_SEC_VAR_NO_INIT_BOOLEAN_NO_CACHEABLE
    #define ENTERED_FEE_START_SEC_VAR_NO_INIT_BOOLEAN_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_NO_INIT_BOOLEAN_NO_CACHEABLE
    ...
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #ifdef ENTERED_FEE_START_SEC_VAR_NO_INIT_BOOLEAN_NO_CACHEABLE
        #undef ENTERED_FEE_START_SEC_VAR_NO_INIT_BOOLEAN_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
    ...
    */
    #undef FEE_START_SEC_VAR_NO_INIT_8_NO_CACHEABLE
    #define ENTERED_FEE_START_SEC_VAR_NO_INIT_8_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_NO_INIT_8_NO_CACHEABLE
    ...
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #ifdef ENTERED_FEE_START_SEC_VAR_NO_INIT_8_NO_CACHEABLE
        #undef ENTERED_FEE_START_SEC_VAR_NO_INIT_8_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
    ...
    */
    #undef FEE_START_SEC_VAR_NO_INIT_16_NO_CACHEABLE
    #define ENTERED_FEE_START_SEC_VAR_NO_INIT_16_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_NO_INIT_16_NO_CACHEABLE
    ...
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #ifdef ENTERED_FEE_START_SEC_VAR_NO_INIT_16_NO_CACHEABLE
        #undef ENTERED_FEE_START_SEC_VAR_NO_INIT_16_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
    ...
    */
    #undef FEE_START_SEC_VAR_NO_INIT_32_NO_CACHEABLE
    #define ENTERED_FEE_START_SEC_VAR_NO_INIT_32_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_NO_INIT_32_NO_CACHEABLE
    ...
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #ifdef ENTERED_FEE_START_SEC_VAR_NO_INIT_32_NO_CACHEABLE
        #undef ENTERED_FEE_START_SEC_VAR_NO_INIT_32_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
    ...
    */
    #undef FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    #define ENTERED_FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    ...
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #ifdef ENTERED_FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_NO_CACHEABLE
        #undef ENTERED_FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
#ifdef FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #undef FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
    #define ENTERED_FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
        #error "MemMap.h, no valid matching start-stop section defined."
        #endif
    #endif
    /**
...
#ifdef FEE_STOP_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #ifdef ENTERED_FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
        #undef ENTERED_FEE_START_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FEE_STOP_SEC_VAR_NO_INIT_UNSPECIFIED_AE_NO_CACHEABLE
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
...
#ifdef FEE_START_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #undef FEE_START_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    #define ENTERED_FEE_START_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
        #error "MemMap.h, no valid matching start-stop section defined."
        #endif
    #endif
    /**
...
#ifdef FEE_STOP_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
    #ifdef ENTERED_FEE_START_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
        #undef ENTERED_FEE_START_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    #else
        #error "MemMap.h, no valid matching start-stop section defined."
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FEE_STOP_SEC_VAR_SHARED_NO_INIT_UNSPECIFIED_NO_CACHEABLE
    /**
    * @file Fee_MemMap.h
    * @violates @ref Fee_MemMap_h_REF_1 MISRA 2004 Required Rule 19.6, use of '#undef' is discouraged
    */
